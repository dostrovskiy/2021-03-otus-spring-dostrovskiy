...
public class QuestionParserImpl implements QuestionParser {
    /**
     * @param list Вопросы, варианты ответов, правильный ответ должны быть каждый в отдельной строке.
     * <ul>
     *   <li>Вопрос, должен быть завершен знаком вопроса ?</li>
     *   <li>Варианты ответов, завершаются точкой .</li>
     *   <li>Правильный ответ имеет знак восклицания ! в конце</li>
     * </ul>
